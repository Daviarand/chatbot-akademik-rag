...
<head>
    ...
    <script src="https://cdn.tailwindcss.com"></script>
    <style>
        /* CSS untuk mengatur Background Website */
        body {
            background-image: url('Background/Background.png');
            /* Mengubah 'cover' menjadi '100% 100%' agar gambar dipaksa pas dengan ukuran layar tanpa dipotong */
...
<body class="h-screen relative font-sans overflow-hidden">
