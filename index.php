...
<body class="bg-gray-100 h-screen flex flex-col">
    ...
    <main id="chat-container" class="flex-1 overflow-y-auto p-4 space-y-4">
        <div class="flex justify-start">
            <div class="bg-white p-3 rounded-lg shadow-sm max-w-[80%]">
                Halo! Saya asisten akademik Informatika UII. Ada yang bisa saya bantu terkait info KRS, syarat lulus,
                atau beasiswa?
            </div>
        </div>
    </main>
    ...
    <footer class="bg-white p-4 border-t">
        <form id="chat-form" class="flex space-x-2">
            ...
            <button type="submit"
                class="bg-blue-600 text-white px-6 py-2 rounded-full hover:bg-blue-700 transition">Kirim</button>
        </form>
    </footer>
    ...
    <script>
        ...
        chatForm.addEventListener('submit', async (e) => {
            ...
            // --- BAGIAN YANG DITAMBAHKAN: Menonaktifkan tombol ---
            ...
            try {
                ...
                // --- BAGIAN YANG DITAMBAHKAN: Mengaktifkan kembali tombol ---
